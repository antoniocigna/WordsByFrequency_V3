...
func g03_get_lemma_row_list( maxNumLemmas int, fromLemmaPref0 string) string {
	...
	for j1, ix2:= range listA {
		...
		if totNumLemmas > 1 { 
			rowW = g05_build_one_lemma_row_word_ManyLemma( ix2,  lemmaSlice[ix2], totNumLemmas)		
		} else {		
			rowW = g05_build_one_lemma_row_word_OnlyOneLemma(ix2, lemmaSlice[ix2], totNumLemmas)
		}
