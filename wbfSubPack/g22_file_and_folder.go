...
var FILE_inpParadigma       string = "X_myParadigma.csv" ; 
...
//------------------------------------------------
const FILE_last_updated_dict_rows  string = "lastUpdated_dict_tran_rows.csv"	
const FILE_last_updated_dict_words string = "lastUpdated_dict_tran_words.csv" 
//const FILE_ outLemmaTranDict  string = "newLemmaTranDict.txt"
const FILE_outLemmaNotFound  string = "newLemmaNotFound.txt"
const FILE_words_to_learn    string = "wordsToLearn.csv"   
